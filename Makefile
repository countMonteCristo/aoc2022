...
day17: days/day17/main.go
	${GO} build -o bin/$@ days/day17/main.go

run_day17: day17
	./bin/day17

day18: days/day18/main.go
	${GO} build -o bin/$@ days/day18/main.go

run_day18: day18
	./bin/day18

day19: days/day19/main.go
	${GO} build -o bin/$@ days/day19/main.go

run_day19: day19
	./bin/day19

day20: days/day20/main.go
	${GO} build -o bin/$@ days/day20/main.go

run_day20: day20
	./bin/day20

day21: days/day21/main.go
	${GO} build -o bin/$@ days/day21/main.go

run_day21: day21
	./bin/day21

day22: days/day22/main.go
	${GO} build -o bin/$@ days/day22/main.go

run_day22: day22
	./bin/day22

day23: days/day23/main.go
	${GO} build -o bin/$@ days/day23/main.go

run_day23: day23
	./bin/day23

day24: days/day24/main.go
	${GO} build -o bin/$@ days/day24/main.go
